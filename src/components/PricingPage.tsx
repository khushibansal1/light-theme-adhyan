                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-8 flex flex-col h-full">
                      ...
                      <button 
                        onClick={() => onNavigate('contact', plan.name.toLowerCase().replace(' plan', ''))}
                        className={`w-full py-3 rounded-lg font-medium transform transition-all duration-300 shadow-lg text-center mt-auto group-hover:scale-105 group-hover:shadow-xl ${
