                ...
                return (
                  <div 
                    ...
                    className={`relative bg-white/90 backdrop-blur-sm rounded-xl border border-gray-200 transition-all duration-500 shadow-lg animate-scale-in flex flex-col h-full group cursor-pointer
                      ...
                      ${plan.color === 'yellow' ? 'hover:border-yellow-400 hover:bg-gradient-to-br hover:from-yellow-50 hover:to-orange-50' :
                        plan.color === 'purple' ? 'hover:border-purple-400 hover:bg-gradient-to-br hover:from-purple-50 hover:to-pink-50' : 
                        'hover:border-blue-400 hover:bg-gradient-to-br hover:from-blue-50 hover:to-cyan-50'}`}
                  ...
                  >
                    ...
                    <div className="p-8 flex flex-col h-full">
                      <div className="text-center mb-8">
                        <div className={`w-16 h-16 mx-auto mb-4 rounded-xl flex items-center justify-center transition-all duration-300 group-hover:scale-110 group-hover:rotate-3 ${
                          plan.color === 'yellow' ? 'bg-yellow-500/20 group-hover:bg-yellow-500/30' :
                          plan.color === 'purple' ? 'bg-purple-500/20 group-hover:bg-purple-500/30' : 'bg-blue-500/20 group-hover:bg-blue-500/30'
                        }`}>
                          <Icon className={`w-8 h-8 transition-all duration-300 ${
                            plan.color === 'yellow' ? 'text-yellow-600 group-hover:text-yellow-700' :
                            plan.color === 'purple' ? 'text-purple-600 group-hover:text-purple-700' : 'text-blue-600 group-hover:text-blue-700'
                          }`} />
                        </div>
